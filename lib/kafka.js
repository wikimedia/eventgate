...
// TODO: move this into a test eventbus_init_module and set config.test.yaml
// eventbus_init_module conf to use it.
/**
 * A fake Kafka producer used for unit tests.
 */
class MockProducer {
    /**
     * Return a mock Promise of a node-rdkafka produce
     * delivery report for testing purposes.
     */
    produce(topic, partition, message, key) {
        if (topic.includes('throw_error')) {
