...
/**
 * Returns a Promise of a connected 'guaranteed' (ACKed) KafkaProducer ready for producing.
...
/**
 * Returns a Promise of a connected 'hasty' (non-ACKed) KafkaProducer ready for producing.
 * @param {Object} config  Kafka config
 * @param {Object} topicConfig Kafka topic config
 * @return {Promise<Object>}
 */
