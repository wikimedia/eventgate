...
/**
 * Given aa bunyan logger and a syslog severity level, this
 * will choose an appropriate bunyan logging level and log.
 *
 * @param {Object} logger bunyan logger
 * @param {int} severity syslog severity level, 0 - 7
 * @param {Object} context  log context object
 * @param {string} message log message
 */
function logAtSyslogSeverity(logger, severity, context, message) {
    switch (severity) {
        case 0:
        case 1:
        case 2:
